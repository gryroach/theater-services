...
class OAuthProvider(ABC):
    ...
    @abstractmethod
    async def get_user_info(self, callback_url: str) -> Dict[str, str]:
        pass
...
class GoogleOAuthProvider(OAuthProvider):
    def __init__(self):
        ...
        self.flow.redirect_uri = f"https://{settings.google_redirect_host}/api-auth/v1/oauth/google/callback"
